                ...
                <div class="w-full mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center md:hidden mt-4 md:mt-0"> 
                            <div class="bg-gray-100 text-center rounded-xl px-4 py-2 pr-8">
                                <div class="text-sm font-bold leading-none">12</div>
                                <div class="text-gray-400 text-xxs font-semibold leading-none">Votes</div>
                            </div>

                            <button type="button"
                                class="w-20 text-xxs bg-gray-200 font-bold uppercase rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-4 py-3 -mx-5"
                            >
                                <span>Vote</span>
                            </button>
                        </div>
